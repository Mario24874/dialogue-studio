...
export function CookieCheck() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-[9998] bg-red-900 border-t border-red-700 px-4 py-3 text-sm text-red-100">
      <strong>Cookies desactivadas.</strong> Dialoghi Studio necesita cookies para iniciar sesión.
      Actívalas en <strong>Configuración → Privacidad → Cookies</strong> y recarga.
    </div>
  )
}
